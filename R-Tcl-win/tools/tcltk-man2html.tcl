...
proc make-man-pages {html args} {
    ...
    puts $manual(short-toc-fp) "<HTML><HEAD><link rel=\"stylesheet\" type=\"text/css\" href=\"R.css\"><TITLE>$overall_title</TITLE></HEAD>"
	...
	puts $manual(wing-toc-fp) "<HTML><HEAD><link rel=\"stylesheet\" type=\"text/css\" href=\"../R.css\"><TITLE>$manual(wing-name) Manual</TITLE></HEAD>"
    ...
    puts $keyfp "<HTML><HEAD><link rel=\"stylesheet\" type=\"text/css\" href=\"../R.css\"><TITLE>$tcltkdesc Keywords</TITLE></HEAD>"
	...
	puts $afp "<HTML><HEAD><link rel=\"stylesheet\" type=\"text/css\" href=\"../R.css\"><TITLE>$tcltkdesc Keywords - $a</TITLE></HEAD>"
...
##    puts $manual(short-toc-fp) {<DT><A HREF="http://www.elf.org">Source</A><DD>More information about these man pages.}
	...
	puts $manual(outfp) "<HTML><HEAD><link rel=\"stylesheet\" type=\"text/css\" href=\"../R.css\"><TITLE>$manual($manual(name)-title)</TITLE></HEAD><BODY>"
